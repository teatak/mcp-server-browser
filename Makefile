.PHONY: help install typecheck build clean pack check release release-patch release-minor release-major _require-clean
...
release: release-patch  ## Alias for release-patch (the common case)
